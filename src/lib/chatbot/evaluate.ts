...
export async function evaluateCandidate(input: EvaluationInput): Promise<EvaluationResult> {
  // Build a rich context of the candidate's answers
...
Respond with a JSON object with exactly these fields:
{
  ...
  "recommendation": "One sentence recommendation for the hiring manager (e.g., 'Strong candidate — recommend scheduling a phone screen within 48 hours.' or 'Borderline candidate — recommend reviewing resume before deciding on interview.')"
}`
