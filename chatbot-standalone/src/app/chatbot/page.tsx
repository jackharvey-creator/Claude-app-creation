...
export const metadata: Metadata = {
  ...
  description:
    'Find out if you\'re a great fit for a career as an Insurance Sales Agent with Comparion Insurance. Take our 90-second readiness assessment and get an instant decision.',
  robots: 'index, follow',
  openGraph: {
    title: 'Are You a Great Fit for Insurance Sales? — Find Out in 90 Seconds',
    description:
