    ...
    <div className="animate-fadeIn space-y-5">
      ...
      {aiSummary && (
        <div className="bg-white border border-gray-200 rounded-xl p-5">
          <h3 className="font-semibold text-gray-800 mb-2">AI Profile Summary</h3>
      ...
      {nearestJob && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
          ...
          <a href={nearestJob.url} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-blue-700 hover:text-blue-900 underline underline-offset-2">
